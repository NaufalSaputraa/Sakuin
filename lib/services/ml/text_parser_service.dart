...
class TextParserService {
  ...
  List<ParsedTransaction> parseBatchText({
    required String text,
    required List<WalletModel> availableWallets,
    required List<CategoryModel> availableCategories,
  }) {
    ...
    if (rawLines.isEmpty) {
      return [parseText(text: text, availableWallets: availableWallets, availableCategories: availableCategories)];
    }
    ...
    return results.isNotEmpty
        ? results
        : [parseText(text: text, availableWallets: availableWallets, availableCategories: availableCategories)];
  }
}
